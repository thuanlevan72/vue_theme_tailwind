<template>
  <div>
    <div
      class="min-h-[60vh] flex flex-col items-center justify-center p-10 bg-gray-100">
      <div
        ...
        <div class="relative mt-10 h-px bg-gray-300">
          <div class="absolute left-0 top-0 flex justify-center w-full -mt-2">
            <span class="bg-white px-4 text-xs text-gray-500 uppercase"
              >Đăng ký các thông tin sau</span
            >
          </div>
        </div>
        <div class="mt-10">
          <form action="#">
            ...
            <div class="flex w-full">
              <button
                ...
                <span class="mr-2 uppercase">Đăng ký</span>
                <span>
                  <svg
                    class="h-6 w-6"
                    fill="none"
